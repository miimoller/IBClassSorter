...
namespace IBClassSorter.Data
{
    public class DataSorter
    {
        ...
        public DataSorter(List<TeacherModel> t, List<ClassModel> cl, List<CourseModel> cr, List<Data.ClassPreferences> cp, List<StudentModel> s, int max)
        {
            allTeachers = t;
            allClasses = cl;
            allCourses = cr;
        ...
        private void runIndividualStudentThread(object args)
        {
            ...
            if (setAllStudentSchedulesBySchoolSchedule(tempPossibleSchedules, currentSchedulePossibility))
            {
                ...
                if (caclTotalSchedules() > maxSchedules)
                {
                    stillUnderMax = false;
                    //TOO MANY***********************************************************************************************************************
                }
